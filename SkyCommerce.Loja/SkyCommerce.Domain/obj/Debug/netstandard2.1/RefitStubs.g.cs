...
namespace SkyCommerce.Interfaces
{
    ...
    partial class AutoGeneratedIFreteApi : IFreteApi
    {
        ...
        /// <inheritdoc />
        Task<IEnumerable<DetalhesFrete>> IFreteApi.Modalidades(string token)
        {
            var arguments = new object[] { token };
            var func = requestBuilder.BuildRestResultFuncForMethod("Modalidades", new Type[] { typeof(string) });
